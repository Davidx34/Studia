      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {topStudents.map((s, idx) => {
              ...
              return (
                <Link
                  key={s.id}
                  href={`/teacher/students/${s.id}`}
                  className="flex items-center gap-4 p-4 rounded-xl premium-card bg-slate-900/40 backdrop-blur-xl hover:border-violet-500/40 transition group"
                >
        ...
        <section className="space-y-3">
          ...
          <Link
            ...
            className="flex items-center gap-3 p-4 rounded-xl premium-card bg-slate-900/40 backdrop-blur-xl hover:border-violet-500/40 transition"
          >
          ...
          <div className="p-4 rounded-xl premium-card bg-slate-900/40 backdrop-blur-xl">
